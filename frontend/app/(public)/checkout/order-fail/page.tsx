      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm mb-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6 pb-6 border-b border-emerald-50">
          <div className="text-left">
            ...
            <p className="text-lg font-mono font-bold text-slate-950">#{orderId || 'INTERNAL_ERROR'}</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-slate-950 text-sm">Common Reasons</p>
              <p className="text-xs text-emerald-900">Insufficient funds, incorrect card details, or bank timeout.</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="bg-slate-100 p-2 rounded-lg text-slate-600">
            ...
            <div>
              <p className="font-bold text-slate-950 text-sm">Need Help?</p>
              <p className="text-xs text-emerald-900">Contact our support if the issue persists.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="bg-emerald-50 min-h-screen py-20 px-4">
      <Suspense fallback={
        <div className="flex flex-col items-center justify-center h-64">
          ...
          <p className="mt-4 text-emerald-900 font-medium">Checking transaction status...</p>
        </div>
      }>
        <FailContent />
      </Suspense>
