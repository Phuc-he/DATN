    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-6 px-4">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-black text-slate-900">Giỏ hàng đang trống</h2>
          <p className="text-slate-500 mt-2">Có vẻ như bạn chưa thêm cuốn sách nào vào giỏ.</p>
        </div>
        <Link 
          href="/shop" 
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-bold text-slate-900 truncate">{book.title}</h3>
                    <p className="text-sm text-slate-500 mb-4">{book.author?.name || 'Tác giả ẩn danh'}</p>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between text-slate-500 font-medium">
                  <span>Tạm tính</span>
                  <span className="text-slate-900">{cartTotal.toLocaleString('vi-VN')}₫</span>
                </div>
                <div className="flex justify-between text-slate-500 font-medium">
                  <span>Giao hàng</span>
