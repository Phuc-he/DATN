        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="relative h-28 w-28">
              {formData.profileImage ? (
                <Image
                  ...
                  alt="Author Preview"
                  fill
                  className="rounded-full object-cover border-2 border-emerald-100 shadow-sm"
                />
              ) : (
                <div className="h-full w-full rounded-full bg-emerald-50 flex items-center justify-center text-slate-300 border-2 border-dashed border-slate-200">
                  <UserIcon size={48} />
                </div>
              )}
              <label className="absolute bottom-0 right-0 p-2 bg-emerald-600 rounded-full text-white cursor-pointer hover:bg-emerald-700 shadow-lg transition-all border-2 border-white">
                <Upload size={14} />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <textarea
                rows={4}
                className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none resize-none transition-all"
                value={formData.bio || ''}
